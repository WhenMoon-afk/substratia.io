...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for Substratia - how we collect, use, and protect your data.",
};
        ...
        <div className="prose prose-invert prose-cyan max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              through our authentication provider (Clerk). This is necessary to
            ...
            <p className="text-gray-300 mb-4">
              If you use the Substratia dashboard, we store the snapshots and
              memories you choose to save. This data is encrypted in transit and
              at rest.
            </p>
            ...
            <p className="text-gray-300 mb-4">
              ...
              page views and feature usage. We do not use third-party tracking
              cookies.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              ...
              <li>
                Authentication is handled by Clerk with secure session
                management
              </li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>
                <strong>Clerk</strong> - Authentication (see their{" "}
                <a
              ...
              <li>
                <strong>Convex</strong> - Database hosting (see their{" "}
                <a
              ...
              <li>
                <strong>Vercel</strong> - Website hosting (see their{" "}
                <a
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mt-4">
              To exercise these rights, contact us through GitHub or your
              account settings.
            </p>
          </section>

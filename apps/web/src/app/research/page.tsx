...
const projects = [
  {
    ...
    githubUrl: siteConfig.links.repos.mirrorDemons,
    featured: true,
  },
  {
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-xl text-gray-300 mb-6 max-w-2xl mx-auto">
            Original investigations into AI behavior, safety, and emergent
            phenomena.
          </p>
          <p className="text-gray-400">
            All research includes open methodology, raw data, and reproducible
            experiments.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto mt-12 p-6 bg-white/5 border border-white/10 rounded-xl">
          <h3 className="text-lg font-semibold mb-3 text-forge-cyan">
          ...
          <ul className="space-y-2 text-gray-400">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-gray-300">Open Data:</strong> Raw
                transcripts and datasets available on GitHub
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-forge-purple mt-1">*</span>
              <span>
                <strong className="text-gray-300">Reproducible:</strong>{" "}
            ...
            <li className="flex items-start gap-2">
              <span className="text-forge-purple mt-1">*</span>
              <span>
                <strong className="text-gray-300">Ethical:</strong> No real
            ...
            <li className="flex items-start gap-2">
              <span className="text-forge-purple mt-1">*</span>
              <span>
                <strong className="text-gray-300">Citable:</strong> BibTeX
                citations provided for academic use
              </span>
            </li>
          </ul>
        </div>
            ...
            <div className="grid gap-4 md:grid-cols-3 mb-8">
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-forge-cyan/20 flex items-center justify-center mb-2">
                  <svg
                    className="w-5 h-5 text-forge-cyan"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-forge-purple/20 flex items-center justify-center mb-2">
                  <svg
                    className="w-5 h-5 text-forge-purple"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >

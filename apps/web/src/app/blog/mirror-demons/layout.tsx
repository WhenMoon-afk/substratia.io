...
export const metadata: Metadata = {
  ...
  description:
    "Original research on how AI chatbots can reinforce and amplify delusional thinking when users present false beliefs as fact.",
  keywords: [
    "AI safety",
    "AI delusions",
    "chatbot psychology",
  ...
  openGraph: {
    ...
    description:
      "Original research on how AI chatbots can reinforce delusional thinking.",
    type: "article",
    ...
    images: [
      {
        url: siteUrl(
          "/api/og?title=Mirror%20Demons&subtitle=AI%20Safety%20Research",
        ),
        width: 1200,
        height: 630,
        alt: "Mirror Demons: How AI Chatbots Can Amplify Delusions",
      },
    ],
  },
  twitter: {
...
const breadcrumbLd = breadcrumb(
  ["Blog", "/blog"],
  ["Mirror Demons", "/blog/mirror-demons"],
);

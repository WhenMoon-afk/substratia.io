...
export const metadata: Metadata = {
  ...
  description:
    "Learn the differences between AGENTS.md and CLAUDE.md files, when to use each, and best practices for configuring AI coding agents.",
  keywords: [
    "AGENTS.md",
    "CLAUDE.md",
  ...
  openGraph: {
    ...
    images: [
      {
        url: siteUrl(
          "/api/og?title=AGENTS.md%20vs%20CLAUDE.md&subtitle=Complete%20Guide",
        ),
        width: 1200,
        height: 630,
        alt: "AGENTS.md vs CLAUDE.md: Complete Guide",
      },
    ],
  },
  twitter: {
...
const breadcrumbLd = breadcrumb(
  ["Blog", "/blog"],
  ["AGENTS.md vs CLAUDE.md", "/blog/agents-md-vs-claude-md"],
);

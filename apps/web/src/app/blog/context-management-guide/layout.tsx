...
export const metadata: Metadata = {
  ...
  description:
    "Master context window management in Claude Code. Learn techniques for preserving context, avoiding compaction issues, and maximizing your AI coding sessions.",
  keywords: [
    "Claude Code context",
  ...
  openGraph: {
    ...
    description:
      "Master context window management in Claude Code. Learn techniques for preserving context and maximizing your AI coding sessions.",
    type: "article",
    ...
    images: [
      {
        url: siteUrl(
          "/api/og?title=Context%20Management&subtitle=The%20Ultimate%20Guide",
        ),
        width: 1200,
        height: 630,
        alt: "The Ultimate Guide to Claude Code Context Management",
      },
    ],
  },
  twitter: {
...
const breadcrumbLd = breadcrumb(
  ["Blog", "/blog"],
  ["Context Management Guide", "/blog/context-management-guide"],
);

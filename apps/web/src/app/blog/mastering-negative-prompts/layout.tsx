...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to use negative prompts effectively to improve AI output quality and avoid common pitfalls.",
  keywords: [
    "negative prompts",
    "AI prompts",
    "prompt engineering",
  ...
  openGraph: {
    ...
    images: [
      {
        url: siteUrl(
          "/api/og?title=Mastering%20Negative%20Prompts&subtitle=For%20AI",
        ),
        width: 1200,
        height: 630,
        alt: "Mastering Negative Prompts for AI",
      },
    ],
  },
  twitter: {
...
const breadcrumbLd = breadcrumb(
  ["Blog", "/blog"],
  ["Mastering Negative Prompts", "/blog/mastering-negative-prompts"],
);

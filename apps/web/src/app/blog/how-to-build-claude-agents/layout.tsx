...
export const metadata: Metadata = {
  ...
  description:
    "Step-by-step guide to building effective Claude Code agents with CLAUDE.md configuration.",
  keywords: [
    "Claude agents",
    "CLAUDE.md",
    "AI agents",
  ...
  openGraph: {
    ...
    images: [
      {
        url: siteUrl(
          "/api/og?title=How%20to%20Build%20Claude%20Agents&subtitle=A%20Practical%20Guide",
        ),
        width: 1200,
        height: 630,
        alt: "How to Build Claude Agents",
      },
    ],
  },
  twitter: {
...
const breadcrumbLd = breadcrumb(
  ["Blog", "/blog"],
  ["How to Build Claude Agents", "/blog/how-to-build-claude-agents"],
);

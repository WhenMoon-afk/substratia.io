...
export const metadata: Metadata = {
  ...
  description:
    "Explore different memory architecture patterns for building AI systems with persistent context.",
  keywords: [
    "memory architecture",
    "AI memory",
    "persistent context",
  ...
  openGraph: {
    ...
    description:
      "Memory architecture patterns for building AI with persistent context.",
    type: "article",
    url: siteUrl("/blog/memory-architecture-patterns"),
    images: [
      {
        url: siteUrl(
          "/api/og?title=Memory%20Architecture&subtitle=Patterns%20for%20AI",
        ),
        width: 1200,
        height: 630,
        alt: "Memory Architecture Patterns for AI",
      },
    ],
  },
  twitter: {
...
const breadcrumbLd = breadcrumb(
  ["Blog", "/blog"],
  ["Memory Architecture Patterns", "/blog/memory-architecture-patterns"],
);

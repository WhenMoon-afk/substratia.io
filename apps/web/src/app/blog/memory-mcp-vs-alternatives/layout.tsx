...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive comparison of MCP memory servers including memory-mcp, mem0, Basic Memory, and Obsidian MCP.",
  keywords: [
    "MCP memory",
    "memory-mcp",
    "mem0",
  ...
  openGraph: {
    ...
    images: [
      {
        url: siteUrl("/api/og?title=MCP%20Memory%20Servers&subtitle=Compared"),
        width: 1200,
        height: 630,
        alt: "MCP Memory Servers Compared",
      },
    ],
  },
  twitter: {
...
const breadcrumbLd = breadcrumb(
  ["Blog", "/blog"],
  ["MCP Memory Servers Compared", "/blog/memory-mcp-vs-alternatives"],
);

...
export const metadata: Metadata = {
  title:
    "Best AI Coding Assistants 2026 - Claude Code vs Cursor vs GitHub Copilot | Substratia",
  description:
    "Compare the top AI coding assistants: Claude Code, Cursor, GitHub Copilot, Codeium, and Windsurf. Features, pricing, and which is best for your workflow.",
  keywords:
    "Claude Code, Cursor AI, GitHub Copilot, Codeium, Windsurf, AI coding assistant, code completion, AI pair programming, best coding AI",
  openGraph: {
  ...
  twitter: {
    ...
    description:
      "Compare Claude Code, Cursor, GitHub Copilot, Codeium, and Windsurf.",
  },
};
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: siteUrl("/reviews/ai-coding-assistants"),
    },
  ],
};

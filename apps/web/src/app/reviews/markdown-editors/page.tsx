...
|------|----------|---------|--------|
${markdownEditors.map((t) => `| ${t.name} | ${t.bestFor} | ${t.pricing} | ${t.rating}/10 |`).join("\n")}
    ...
    <main className="min-h-screen text-white">
      <div className="container mx-auto px-4 py-12">
        <ReviewHeader
          config={{
            backHref: "/reviews",
            shareTitle: "Best Markdown Editors 2026 - Substratia",
            heading: "Best Markdown Editors",
            headingAccent: "2026",
            subtitle:
              "A comprehensive comparison of the top tools for writing and organizing in markdown.",
            lastUpdated: "January 2026",
            itemCount: markdownEditors.length,
            author: "Substratia",
            downloadFilename: "markdown-editors-comparison.md",
          }}
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          {markdownEditors.map((tool, index) => (
            <div
              key={tool.name}
        ...
        {/* Recommendations */}
        <div className="mt-16">
          <Recommendations items={markdownEditorRecommendations} columns={3} />
        </div>

        {/* CTA */}
        <div className="mt-16">
          <ReviewCtaSection cta={markdownEditorCta} />
        </div>
      </div>
    </main>
  );

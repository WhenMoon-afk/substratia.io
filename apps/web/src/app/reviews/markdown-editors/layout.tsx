...
export const metadata: Metadata = {
  title:
    "Best Markdown Editors 2026 - Obsidian vs Notion vs Typora | Substratia",
  description:
    "Compare the top markdown editors: Obsidian, Notion, Typora, VS Code, and iA Writer. Features, pricing, and which is best for notes, docs, and writing.",
  keywords:
    "Obsidian, Notion, Typora, markdown editor, note taking app, VS Code markdown, iA Writer, best markdown editor, PKM tools",
  openGraph: {
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: siteUrl("/reviews/markdown-editors"),
    },
  ],
};
...
const jsonLd = {
  ...
  description:
    "A comparison of the top markdown editors for writers and developers.",
  itemListElement: [
    {
      "@type": "ListItem",
      position: 1,

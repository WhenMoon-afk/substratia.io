...
export const categories: PromptCategory[] = [
  { id: 'communication', name: 'Communication', icon: '\u{1F4AC}', color: 'cyan' },
  { id: 'creative', name: 'Creative', icon: '\u{1F3A8}', color: 'purple' },
  { id: 'productivity', name: 'Productivity', icon: '\u26A1', color: 'cyan' },
  { id: 'business', name: 'Business', icon: '\u{1F4C8}', color: 'purple' },
]
